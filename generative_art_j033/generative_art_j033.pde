...
void setup() {
  ArrayList<ArrayList<PVector>> stack1, stack2, stack3, stack4;
  ...
  for (int i = 0; i < 20; i++) {
    ...
    stack1 = polystack(random(width), random(height), random(width/6, width/3), 10);
    stack2 = polystack(random(width), random(height), random(width/6, width/3), 10);
    stack3 = polystack(random(width), random(height), random(width/6, width/3), 10);
    stack4 = polystack(random(width), random(height), random(width/6, width/3), 10);
  
    stacklist_add(stacklist, stack1, color(random(100), random(40, 60), 70, 4));
    stacklist_add(stacklist, stack2, color(random(100), random(40, 60), 70, 4));
    stacklist_add(stacklist, stack3, color(random(100), random(40, 60), 70, 4));
    stacklist_add(stacklist, stack4, color(random(100), random(40, 60), 70, 4));
